...
public class WARCFileRecordReader implements RecordReader<Text, ArchiveReader> {
	...
	public WARCFileRecordReader(InputSplit inputSplit, JobConf conf, Reporter reporter) throws IOException {
...
//	}
	...
	@Override
	public boolean next(Text inputText, ArchiveReader inputAr) throws IOException {
		if (hasBeenRead) {
			return false;
		} else {
			inputText = this.createKey();
			inputAr = this.createValue();
			hasBeenRead = true;
			return true;
		}
	}
